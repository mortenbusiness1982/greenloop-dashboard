...
export type WorkflowProduct={id:string;ean:string;name:string|null;brandName:string|null;state:string;runId:string|null;missingFields?:string[];completeness?:number;contributions?:string[];photoFlags?:string[]};
